...
@section('content')
          ...
          <div class="card-body">
            <div class="row mb-3">
              <div class="col d-flex align-items-center gap-2">
                  ...
                  <button class="btn btn-primary" id="btn-add">Add Product Category</button>
              </div>
              <div class="col-md-4">
            ...
            <table id="product-categorys-table" class="table">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Name</th>
    ...
    <!-- Modal -->
    <div class="modal modal-blur" id="modal-product-categorys" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Form Data Product Category</h5>
...
@push('after-js')
<script src="/js/pages/product-category.js"></script>
@endpush