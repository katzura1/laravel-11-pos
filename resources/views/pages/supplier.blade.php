...
@section('content')
          ...
          <div class="card-body">
            <div class="row mb-3">
              <div class="col d-flex align-items-center gap-2">
                  ...
                  <button class="btn btn-primary" id="btn-add">Add Supplier</button>
              </div>
              <div class="col-md-4">
    ...
    <!-- Modal -->
    <div class="modal modal-blur fade" id="modal-suppliers" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Form Data Supplier</h5>
